...
<div class="auth-wrapper">
    <div class="container-fluid h-100">
        <div class="row flex-row h-100 bg-white">
            <div class="col-xl-8 col-lg-4 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                <div class="lavalite-bg" style=" url('<?php echo asset('sximo5/images/register-bg.jpg');?>')">
                    <div><img src="Prancheta-1-cópia.jpg"></div>
                </div>
            </div>
                ...
                <div class="login-box">
                    ...
                    <div class="text-center">
                        @if(file_exists(public_path().'/uploads/images/'.config('sximo')['cnf_logo']) && config('sximo')['cnf_logo'] !='')
                            <img src="{{ asset('uploads/images/'.config('sximo')['cnf_logo'])}}"
                                 alt="{{ config('sximo')['cnf_appname'] }}" width="90"/><br>
                        @else
