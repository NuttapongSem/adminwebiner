		 ...
		 {!! Form::open(array('url'=>'userrecord', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> UserRecord</legend>
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <textarea name='image' rows='5' id='image' class='form-control form-control-sm '  
				           >{{ $row['image'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='checkin_date' id='checkin_date' value='{{ $row['checkin_date'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='checkin_time' id='checkin_time' value='{{ $row['checkin_time'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
					 	...
					 	<div class="input-group-text"><i class="fa fa-calendar"></i></span></div>
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='seminar_id' id='seminar_id' value='{{ $row['seminar_id'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="Is Pass" class=" control-label col-md-4 text-left"> Is Pass </label>
										<div class="col-md-6">
										  <input  type='text' name='is_pass' id='is_pass' value='{{ $row['is_pass'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#user_id").jCombo("{!! url('userrecord/comboselect?filter=users:id:id') !!}",
